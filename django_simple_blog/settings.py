...
SECRET_KEY = 'ui0ojqb3yk$$%o$r&h6!g)$%d9fn0wmgc!69$iu2iyqc8#*h6p'
...
WSGI_APPLICATION = 'django_simple_blog.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_dir")
